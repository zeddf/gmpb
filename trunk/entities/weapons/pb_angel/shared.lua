...
SWEP.ViewModel				= "models/paintball/weapons/v_angel/v_angel.mdl"
...
function SWEP:PrimaryAttack(data)
	...
	if pb:IsValid() then
		...
		local acuracy = 63 // The higher the number the more accurate, the lower the number it is more accurate. The number should never be below 40 or 50... unless you want a super inacurate gun..
