...
local function FlagEvent( message )

	local capper 	= message:ReadString();
	local event 	= message:ReadString();
	
	GAMEMODE:AddFlagEvent( capper, event )	
end
	
usermessage.Hook( "FlagEvent", FlagEvent )
...
function GM:AddFlagEvent( capper, event )
