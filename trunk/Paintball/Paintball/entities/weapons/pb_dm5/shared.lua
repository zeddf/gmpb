...
SWEP.ViewModel				= "models/paintball/weapons/v_dm4/v_dm4.mdl"
...
function SWEP:PrimaryAttack(data)
	...
	if pb:IsValid() then
		...
		local acuracy = 70 // The higher the number the more accurate, the lower the number it is more accurate. The number should never be below 40 or 50... unless you want a super inacurate gun..
