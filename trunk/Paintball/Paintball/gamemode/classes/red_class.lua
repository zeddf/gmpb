...
CLASS.StartArmor			= 0
CLASS.RespawnTime           = 0 // 0 means use the Red spawn time chosen by gamemode
...
function CLASS:OnSpawn( pl )
	local modelname = "models/player/police.mdl"
...
player_class.Register( "Red", CLASS )