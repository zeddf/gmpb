...
SWEP.ViewModel				= "models/paintball/weapons/v_a51/v_a51.mdl"
...
function SWEP:PrimaryAttack(data)
	...
	self.Weapon:SetNextPrimaryFire( CurTime() + 0.16 )
	...
	if pb:IsValid() then
		...
		local acuracy = 58 // The higher the number the more accurate, the lower the number it is more accurate. The number should never be below 40 or 50... unless you want a super inacurate gun..
