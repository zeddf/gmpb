...
CLASS.StartArmor			= 0
CLASS.RespawnTime           = 0 // 0 means use the Spec spawn time chosen by gamemode
...
function CLASS:Loadout( pl )
	...
	if pl:Team() == TEAM_BLUE || pl:Team() == TEAM_Spec then
		if pl:GetNetworkedString("GMPBWeapon", "pb_blazer" ) == "pb_testweapon" then
			pl:Give("pb_testweapon")
...
player_class.Register( "Spec", CLASS )